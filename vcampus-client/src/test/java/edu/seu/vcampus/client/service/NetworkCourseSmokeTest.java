...
/** Optional live-server smoke test for the course selection protocol. */
public class NetworkCourseSmokeTest {
    @Test
    public void queriesCoursesAndScheduleOverSocket() throws Exception {
        ...
        try {
            ...
            CourseClientService service =
                    new CourseClientService(connection, session.getSessionToken());
            assertFalse(service.queryCourses(null).isEmpty());
