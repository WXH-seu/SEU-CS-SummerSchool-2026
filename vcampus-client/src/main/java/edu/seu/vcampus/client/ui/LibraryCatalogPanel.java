 ...
 * 图书馆书目检索、借阅与维护页。
 */
public final class LibraryCatalogPanel extends JPanel {
    ...
    private void buildUi() {
        ...
        north.add(SeuPanels.heading(
                "图书馆 · 书目（" + effectiveRole.getDisplayName() + "）", statusLabel),
                BorderLayout.NORTH);
    ...
    private void borrowSelected() {
        ...
        if (!SeuMessages.confirm(this, "确定借阅「" + book.getTitle() + "」吗？借期 30 天。")) {
            return;
        }
        setBusy(true, "正在借阅……");
        new SwingWorker<BorrowRecordDto, Void>() {
            ...
            protected BorrowRecordDto doInBackground() throws Exception {
                return service.borrowBook(book.getIsbn());
            }
            ...
            protected void done() {
                try {
                    ...
                    SeuMessages.info(LibraryCatalogPanel.this, "借阅成功",
